...
<!-- Title: Contributing GitFlow CookiecutterTemplate -->
...
To contribute to cookiecutter-template project on [GitHub](https://github.com/hadenlabs/cookiecutter-template), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/cookiecutter-template/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to cookiecutter-template project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/cookiecutter-template.git
```

Now your **upstream** points to **hadenlabs/cookiecutter-template**.
...
git fetch upstream # assuming upstream is hadenlabs/cookiecutter-template
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/cookiecutter-template/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
